...
<div class="form-wrapper">
    <div class="btn-group">
        <a href="{{route('officers.index')}}" class="btn btn-primary"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a>
    </div>
    {!! Form::model($officer, ['action' => ['OfficerController@update', $officer->id], 'method' => 'POST']) !!}

    <div class="panel panel-default">
        <div class="panel-heading">Register Officer</div>
